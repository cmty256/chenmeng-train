  ...
  setup() {
    ...
    const format = () => {
      ...
      for (let i = 0; i < list.value.length; i++) {
        ...
        // 假设6站：start = 1, end = 3, sellDB = 11111，最终得到：sell = 01110，转int 1100，大于1-不可买
        // 假设6站：start = 1, end = 3, sellDB = 11011，最终得到：sell = 01010，转int 1000，大于1-不可买
        // 假设6站：start = 1, end = 3, sellDB = 10001，最终得到：sell = 00000，转int 0，小于1-可买
        // 验证代码：
